import{d as x,j as i}from"./index-dy2A5GxR.js";import{r as u}from"./react-vendor-KOjhOASN.js";import{f as p,h as L,m as h,j as y,u as j,k as b}from"./firebase-vendor-CMaS3_GD.js";import{y as S}from"./ui-vendor-CH5ACy0w.js";const $=(m,g)=>{const[f,r]=u.useState(0),[n,c]=u.useState(!1),[t,l]=u.useState(!0),s=`${g}_${m}`,a=`liked_${s}`;return u.useEffect(()=>{const o=localStorage.getItem(a)==="true";c(o);const e=p(x,"likes",s),k=L(e,d=>{d.exists()?r(d.data().count||0):r(0),l(!1)},d=>{console.error("Error escuchando likes:",d),l(!1)});return()=>k()},[s,a]),{likes:f,isLiked:n,toggleLike:async()=>{const o=!n;c(o),r(e=>o?e+1:e-1),o?localStorage.setItem(a,"true"):localStorage.removeItem(a);try{const e=p(x,"likes",s);(await h(e)).exists()?await j(e,{count:b(o?1:-1)}):o&&await y(e,{count:1})}catch(e){console.error("Error actualizando likes:",e)}},loading:t}},D=({itemId:m,itemType:g,className:f="",showCount:r=!0,size:n=20})=>{const{likes:c,isLiked:t,toggleLike:l,loading:s}=$(m,g);return i.jsxs("button",{onClick:a=>{a.stopPropagation(),l()},disabled:s,className:`

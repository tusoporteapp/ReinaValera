import{d as x,j as i}from"./index-CNDHqYUK.js";import{r as u}from"./react-vendor-KOjhOASN.js";import{f as p,h as L,j as h,k as j,u as y,n as b}from"./firebase-vendor-DovfRJH6.js";import{I as S}from"./ui-vendor-C7KNVAlS.js";const I=(g,m)=>{const[f,r]=u.useState(0),[n,c]=u.useState(!1),[t,l]=u.useState(!0),s=`${m}_${g}`,a=`liked_${s}`;return u.useEffect(()=>{const o=localStorage.getItem(a)==="true";c(o);const e=p(x,"likes",s),k=L(e,d=>{d.exists()?r(d.data().count||0):r(0),l(!1)},d=>{console.error("Error escuchando likes:",d),l(!1)});return()=>k()},[s,a]),{likes:f,isLiked:n,toggleLike:async()=>{const o=!n;c(o),r(e=>o?e+1:e-1),o?localStorage.setItem(a,"true"):localStorage.removeItem(a);try{const e=p(x,"likes",s);(await h(e)).exists()?await y(e,{count:b(o?1:-1)}):o&&await j(e,{count:1})}catch(e){console.error("Error actualizando likes:",e)}},loading:t}},D=({itemId:g,itemType:m,className:f="",showCount:r=!0,size:n=20})=>{const{likes:c,isLiked:t,toggleLike:l,loading:s}=I(g,m);return i.jsxs("button",{onClick:a=>{a.stopPropagation(),l()},disabled:s,className:`

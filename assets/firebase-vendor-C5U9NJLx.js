 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ob(n){KS(Ln),rt(new Ze("database",(e,{instanceIdentifier:t})=>{const s=e.getProvider("app").getImmediate(),i=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return bb(s,i,r,t)},"PUBLIC").setMultipleInstances(!0)),$e(pd,md,n),$e(pd,md,"esm2020")}St.prototype.simpleListen=function(n,e){this.sendRequest("q",{p:n},e)};St.prototype.echo=function(n,e){this.sendRequest("echo",{d:n},e)};Ob();export{Qb as a,Yb as b,Xb as c,Lb as d,$b as e,xb as f,Fb as g,Hb as h,cE as i,jb as j,Gb as k,qb as l,Kb as m,Bb as o,Ub as q,Wb as s,zb as u};
